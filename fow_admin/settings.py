"""
Django settings for fow_admin project.
...
ALLOWED_HOSTS = ['aleksfrost.pythonanywhere.com', '127.0.0.1']
...
WSGI_APPLICATION = 'fow_admin.wsgi.application'
